...
export const industries: Industry[] = [
  { id: "roofing", name: "Roofing", brand: "[Brand Here]", tagline: "Roofs that outlast the weather.", cta: "Schedule free inspection", hue: "from-orange-500 to-red-500", img: roof, services: ["Asphalt Shingles", "Metal Roofing", "Storm Damage", "Inspections"], review: { who: "Mark, Atlanta GA", text: "Crew finished a full re-roof in 2 days. Cleaner than we left the yard." } },
  { id: "landscaping", name: "Landscaping", brand: "[Brand Here]", tagline: "Yards the whole street notices.", cta: "Get free design quote", hue: "from-emerald-500 to-teal-500", img: lawn, services: ["Lawn Care", "Hardscaping", "Garden Design", "Tree Service"], review: { who: "Linda, Chicago IL", text: "They turned a patch of dirt into the nicest yard on our block." } },
  { id: "pressure", name: "Pressure Washing", brand: "[Brand Here]", tagline: "Restore what time and weather took.", cta: "Book a wash", hue: "from-sky-500 to-blue-600", img: pressure, services: ["Driveways", "House Soft Wash", "Decks & Patios", "Commercial"], review: { who: "Diane, Tampa FL", text: "The driveway looks brand new. Wish I'd called them years ago." } },
  { id: "hvac", name: "HVAC", brand: "[Brand Here]", tagline: "Comfort, on call. 24/7.", cta: "Request service today", hue: "from-blue-500 to-indigo-600", img: hvac, services: ["AC Repair", "Heating", "Heat Pumps", "Maintenance Plans"], review: { who: "Carlos, Phoenix AZ", text: "Same-day install in 105° heat. Lifesavers." } },
  { id: "detailing", name: "Mobile Detailing", brand: "[Brand Here]", tagline: "Showroom shine — in your driveway.", cta: "Book mobile detail", hue: "from-zinc-700 to-zinc-900", img: detail, services: ["Full Detail", "Paint Correction", "Ceramic Coating", "Interior Deep Clean"], review: { who: "Jamie, Austin TX", text: "Car hasn't looked this good since I drove it off the lot." } },
  { id: "plumbing", name: "Plumbing", brand: "[Brand Here]", tagline: "Fix it once. Fix it right.", cta: "Get a plumber out", hue: "from-cyan-500 to-blue-600", img: plumb, services: ["Emergency Repair", "Water Heaters", "Drain Cleaning", "Remodels"], review: { who: "Sarah, Denver CO", text: "Showed up in 40 min on a Sunday. Fair price. Done." } },
  { id: "realestate", name: "Real Estate", brand: "[Brand Here]", tagline: "Find the home. Make the move.", cta: "Browse listings", hue: "from-amber-500 to-pink-600", img: re, services: ["Listings", "Home Valuation", "Buyer Services", "Investment"], review: { who: "Aaron & Mia, Seattle WA", text: "Closed in 32 days, over asking. They made it look easy." } },
  { id: "construction", name: "Construction", brand: "[Brand Here]", tagline: "Build to last. Build on time.", cta: "Request project quote", hue: "from-orange-500 to-amber-600", img: con, services: ["New Builds", "Renovations", "Commercial", "Design-Build"], review: { who: "Westside Dental", text: "Came in under budget on a 6,000 sq ft buildout. Refreshing." } },
];
