...
export const industries: Industry[] = [
  ...
  { id: "realestate", name: "Real Estate", brand: "Real Estate", tagline: "Find the home. Make the move.", cta: "Browse listings", hue: "from-amber-500 to-pink-600", img: re, services: ["Listings", "Home Valuation", "Buyer Services", "Investment"], review: { who: "Aaron & Mia, Seattle WA", text: "Closed in 32 days, over asking. They made it look easy." } },
  { id: "construction", name: "Contracting & Construction", brand: "Contracting & Construction", tagline: "Build to last. Build on time.", cta: "Request project quote", hue: "from-orange-500 to-amber-600", img: con, services: ["New Builds", "Renovations", "Commercial", "Design-Build"], review: { who: "Westside Dental", text: "Came in under budget on a 6,000 sq ft buildout. Refreshing." } },
];
